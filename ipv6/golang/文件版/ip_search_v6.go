...
func GetDistrictObjectV6(file string) *IpInfoV6 {
	onceV6.Do(func() {
		objV6 = &IpInfoV6{}
		var err error
		objV6, err = LoadFileV6(file)
		if err != nil {
...
func LoadFileV6(file string) (*IpInfoV6, error) {
	...
	p.numbers = UnpackInt4byteV6(data[4], data[5], data[6], data[7])
...
func (p *IpInfoV6) GetAddr(row uint32) string {
	j := p.numbers*12 + 4 + 4 + (row * 55)
